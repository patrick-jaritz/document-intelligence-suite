-- Update match_document_chunks function to use document_chunks table instead of document_embeddings
-- This fixes the issue where RAG queries were looking in the wrong table
